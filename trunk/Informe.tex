...
\input{./Circuitos-Teoricos/Pago-a-Proveedores/circuito-pago-a-proveedores.tex}
\chapter{Circuito Producci\'on}
\input{./Circuitos-Teoricos/Produccion/circuito-produccion.tex}
...
\input{./Empresa/Circuitos/Compras/Compra-de-materiales-y-entrada-de-inventario.tex}
\chapter{Circuito Ventas}
\input{./Empresa/Circuitos/Ventas/Ventas-con-transporte-propio.tex}
\chapter{Circuito Cobranzas}
\input{./Empresa/Circuitos/Cobranzas/Cobro-de-facturas.tex}

\part{Presupuesto}
\includepdf[pages=1-6, angle=90, pagecommand={\thispagestyle{empty}}]{Presupuesto/PRESUPUESTOS.pdf}
